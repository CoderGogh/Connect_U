...
@Tag(name = "Posts", description = "게시글(Post) 좋아요 추가 및 취소 API")
public class PostLikeController {

	private final PostLikeService postLikeService;

	@PostMapping("/{postId}")
	@Operation(summary = "게시글 좋아요 추가", description = "로그인한 사용자가 특정 게시글에 좋아요를 추가합니다.")
	...
	@Operation(summary = "게시글 좋아요 취소", description = "로그인한 사용자가 특정 게시글의 좋아요를 취소합니다.")
